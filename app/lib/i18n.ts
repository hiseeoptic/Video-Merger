...
export const MESSAGES: Record<Lang, Messages> = {
  vi: {
    ...
    folder_selected: (name) => `Nút tải và Xuất tất cả sẽ lưu vào: ${name}`,
    ...
    toast_folder_selected: (name) => `Đã chọn thư mục ${name}. Nút tải và Xuất tất cả sẽ lưu video tại đây.`,
  ...
  en: {
    ...
    folder_selected: (name) => `Download and Export all save to: ${name}`,
    ...
    toast_folder_selected: (name) => `Selected ${name}. Download and Export all will save videos there.`,
  ...
  fr: {
    ...
    folder_selected: (name) => `Téléchargement et Tout exporter vers : ${name}`,
    ...
    toast_folder_selected: (name) => `Dossier ${name} sélectionné. Télécharger et Tout exporter y enregistreront les vidéos.`,
  ...
  zh: {
    ...
    folder_selected: (name) => `下载和全部导出将保存到：${name}`,
    ...
    toast_folder_selected: (name) => `已选择 ${name}，下载和全部导出都会将视频保存到该文件夹。`,
